 ...
 */
#ifndef __CAMERA_ORBITAL_TARGET_H__
#define __CAMERA_ORBITAL_TARGET_H__
...
/*!
 * \class CameraOrbitalTarget
 * \brief Classe permettant de gérer une caméra orbitale autour d'un point.
 */
class CameraOrbitalTarget : public CameraAbstract
{
	...
	public:
		 ...
		 */
		CameraOrbitalTarget(Ogre::String cameraName, Ogre::Vector3 position = Ogre::Vector3(0.0, 0.0, 0.0));
		/*!
		 * \brief Constructeur
		 * \param cameraType Type nouvelle caméra
		 * \param cameraName Nom de la nouvelle caméra
		 ...
		 */
		CameraOrbitalTarget(Ogre::String cameraName, Ogre::SceneNode * targetNode);
		/*!
		 * \brief Destructeur
		 */
		~CameraOrbitalTarget();
	...
	private:
        ...
        */
		 ...
		 */
        void moveCameraOrbitalTarget(Ogre::Vector3 vector);
...
#endif //__CAMERA_ORBITAL_TARGET_H__
